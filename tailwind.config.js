...
module.exports = {
  ...
  purge: {
    ...
    enabled: ['production', 'staging', 'mirror'].includes(process.env.NODE_ENV),
    content: [
      'components/**/*.vue',
      'layouts/**/*.vue',
      'pages/**/*.vue',
  ...
  theme: {
    ...
    boxShadow: {
      ...
      outline: '0 0 0 2px #51b848',
      'header': '0 2px 8px rgb(0 0 0 / 5%)',
      'vuetify': '0px 5px 5px -3px rgb(0 0 0 / 20%), 0px 8px 10px 1px rgb(0 0 0 / 14%), 0px 3px 14px 2px rgb(0 0 0 / 12%)',
    },
    cursor: {
      auto: 'auto',
      default: 'default',
    ...
    fontFamily: {
      sans: ["'SVN-Gilroy'", "Roboto", "sans-serif"],
    ...
    plugin(function ({addComponents, config}) {
      const container = {
        '.container': {
          ...
          '@screen lg': {
            maxWidth: '1234px',
            paddingLeft: config('theme.spacing.8'),
            paddingRight: config('theme.spacing.8'),
          },
          '@screen xl': {
            maxWidth: '1592px',
          },
